...
const textures: Dictionary = {
	OreTemplate.Ores.Gold: "res://assets/sprites/items/ores/gold_ore.png",
	OreTemplate.Ores.Iron: "res://assets/sprites/items/ores/iron_ore.png",
	OreTemplate.Ores.Copper: "res://assets/sprites/items/ores/copper_ore.png",
}
